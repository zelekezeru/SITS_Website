                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="description"
                                ...
                                placeholder="Event Description" value="{{ old('description') }}">
                            @error('description')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="location"
                                ...
                                placeholder="Event Location" value="{{ old('location') }}" required>
                            @error('location')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="remark"
                                ...
                                placeholder="Event Remarks" value="{{ old('remark') }}">
                            @error('remark')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="file" name="banner"
                                class="form-control @error('banner') is-invalid @enderror" id="inputBanner">
                            @error('banner')
                                <div class="form-text text-danger">{{ $message }}</div>
                            @enderror
                        </div>

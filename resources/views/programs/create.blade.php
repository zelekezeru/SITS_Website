<x-admin-layout>
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h1 class="font-outfit text-3xl font-extrabold text-white tracking-tight">Add New Program</h1>
                <p class="text-sm text-slate-400">Create a new academic program entry.</p>
            </div>

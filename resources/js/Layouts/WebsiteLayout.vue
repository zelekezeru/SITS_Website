        ...
        <div class="flex justify-between items-center h-16">
          ...
          <ul class="hidden lg:flex items-center gap-1 text-sm font-semibold text-slate-400">
            ...
            <li v-if="auth.user" class="relative group">
              ...
              <div class="absolute left-0 top-full pt-2 w-60 hidden group-hover:block z-50">
                <div class="bg-slate-900/95 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl py-2">
        ...
        <div v-if="mobileMenuOpen" class="lg:hidden border-t border-slate-900/60 bg-slate-950/98 backdrop-blur-xl shadow-2xl">
          <div class="px-4 pt-3 pb-5 space-y-1">
            ...
            <template v-if="auth.user">
              ...
              <!-- Cross-app portals — role-gated server-side -->
              <PortalSwitcher variant="drawer" @navigate="mobileMenuOpen = false" />
            </template>

  ...
  <GuestLayout>
    ...
    <div class="flex flex-col items-center mb-8">
      ...
      <p class="text-slate-400 mt-2 text-sm text-center max-w-sm">
        You're signing in with a default or recovery password. Confirm it below and choose
        a new one to continue — this also unlocks the LMS and the other SITS portals.
      </p>
    </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              :class="form.errors.current_password ? 'border-rose-500/50 focus:border-rose-500/50 focus:ring-rose-500/50' : 'border-slate-850'"
            />
          </div>
          <div v-if="form.errors.current_password" class="text-xs text-rose-450 mt-1 font-semibold">

    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg p-8 space-y-6 border border-transparent dark:border-gray-800">
                    <div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Maximum size: 50MB</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                        >
                    ...
                    <div class="flex items-center justify-end mt-4 pt-4 border-t dark:border-gray-800">
                        <Link :href="route('library.archive.index')" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 mr-4 transition">
                            Cancel
                        </Link>

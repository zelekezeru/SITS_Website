    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                ...
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight border-l pl-3 border-gray-300 dark:border-gray-700">
                    Edit Title
                </h2>
            </div>
        </template>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input v-model="form.edition" type="text" class="mt-1 block w-full bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" />
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                            <Link :href="route('library.catalog.show', book.id)" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 font-medium transition">Cancel</Link>

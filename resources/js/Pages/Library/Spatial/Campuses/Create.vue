                    ...
                    <div class="p-8">
                        <form @submit.prevent="submit" class="space-y-8">
                            <div>
                                ...
                                <TextInput id="name" type="text" class="mt-1 block w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800 focus:ring-2 focus:ring-indigo-500 transition-all" v-model="form.name" required autofocus placeholder="e.g. Science & Technology Park" />
                                <InputError class="mt-2" :message="form.errors.name" />
                            </div>

                            <div>
                                <InputLabel for="code" value="Campus Code" class="text-[10px] font-black uppercase tracking-[0.2em] mb-2 text-gray-400" />
                                <TextInput id="code" type="text" class="mt-1 block w-full rounded-2xl border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800 font-mono focus:ring-2 focus:ring-indigo-500 transition-all" v-model="form.code" required placeholder="STP-01" />
                            ...
                            <div class="flex items-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 transition-colors">
                                ...
                                <label for="is_active" class="ml-4 text-sm font-bold text-gray-700 dark:text-gray-300">Set as Operational</label>
                            </div>

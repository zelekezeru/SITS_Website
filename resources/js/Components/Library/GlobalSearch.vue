...
const quickActions = computed(() => {
    const all = [
        { type: 'action', label: 'Dashboard',       route: 'dashboard',         icon: '🏠' },
        { type: 'action', label: 'Browse Catalog',   route: 'catalog.index',     icon: '📚', permission: 'view_books' },
        { type: 'action', label: 'Checkout Desk',    route: 'circulation.desk',  icon: '✅', permission: 'checkout_book' },
        { type: 'action', label: 'Process Returns',  route: 'circulation.returns', icon: '↩️', permission: 'return_book' },
        { type: 'action', label: 'Add New Book',     route: 'books.create',      icon: '➕', permission: 'create_book' },
        { type: 'action', label: 'Scan & Place',     route: 'scan.place',        icon: '📱', permission: 'create_book' },
        { type: 'action', label: 'Transfers',        route: 'transfers.index',   icon: '🔄', permission: 'request_transfer' },
        { type: 'action', label: 'My Loans',         route: 'my.loans',          icon: '📋' },
        { type: 'action', label: 'My Holds',         route: 'my.holds',          icon: '🔔' },
        { type: 'action', label: 'My Fines',         route: 'my.fines',          icon: '💰' },
        { type: 'action', label: 'Digital Archive',   route: 'archive.index',    icon: '📄', permission: 'view_secure_pdf' },
        { type: 'action', label: 'External Resources', route: 'resources.index', icon: '🔗' },
        { type: 'action', label: 'Manage Users',     route: 'users.index',       icon: '👥', permission: 'manage_users' },
        { type: 'action', label: 'Campuses',         route: 'campuses.index',    icon: '🏛️', permission: 'manage_campus' },
        { type: 'action', label: 'Reports',          route: 'reports.index',     icon: '📊', permission: 'view_loans' },
        { type: 'action', label: 'Stocktake',        route: 'stocktakes.index',  icon: '📦', permission: 'manage_shelf_box' },
        { type: 'action', label: 'Audit Log',        route: 'admin.audit',       icon: '📝', permission: 'manage_campus' },
        { type: 'action', label: 'Fines Management', route: 'fines.index',       icon: '💳', permission: 'collect_fine' },
    ];

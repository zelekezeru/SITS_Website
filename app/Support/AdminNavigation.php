        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    self::item('Attendance Permissions', 'admin.attendance-permissions', '/admin/attendance-permissions', 'CalendarCheck',
                        'Excused-absence requests created by Admin/Operations and approved before payroll.',
                        ['Permitted days', 'Maker-checker approval', 'Feeds attendance']),
                    self::item('Closed Days (Holidays)', 'admin.closed-days', '/admin/closed-days', 'CalendarX',
                        'Calendar of official holidays and institutional closed days.',
                        ['Holiday registry', 'Active/inactive status', 'Date-based tracking']),
                    self::item('Mass Permissions', 'admin.mass-permissions', '/admin/mass-permissions', 'UserCheck',
                        'Batch excuse absences for holidays and closed days across all employees.',
                        ['Two-layer approval', 'Auto-creates attendance permissions', 'Maker-checker workflow']),
